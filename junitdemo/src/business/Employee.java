...
public class Employee {
	...
	//when we need to compare user defined class we need to override this block
	//because if we do not, it will point to different hash-code and it will not able to compare
	@Override
